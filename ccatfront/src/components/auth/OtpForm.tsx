...
export default function OtpForm({ email, otp, resendCountdown, onOtpChange, onOtpKey, onResend, onNavigate, onSubmit }: Props) {
  const { t } = useI18n()
  const l = t.login
    ...
    <>
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        {resendCountdown > 0
          ...
          : <button type="button" onClick={onResend} className="text-blue-600 font-semibold hover:underline">Resend</button>
        }
      </p>
    </>
  )
